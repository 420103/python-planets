...
def PlanetInfo():
    ...
    if planet == "Mercury":
        ...
        label_planet_gravity_radius['text'] = "Gravity : 3.70 m/s² and Radius : 2,439.7 km"
        ...
        label_planet_gravity_radius['text'] = "Gravity : 8.87 m/s² and Radius : 6,051.8 km"
        ...
        label_planet_gravity_radius['text'] = "Gravity : 9.807 m/s² and Radius : 6,371 km"
        label_planet_info['text'] = "Earth is the only place in the known universe, Which contains life support. It's the only one known for sure to have liquid water on it's surface."
...
label_planet_gravity_radius.place(relx=0.5, rely=0.7, anchor=CENTER)
